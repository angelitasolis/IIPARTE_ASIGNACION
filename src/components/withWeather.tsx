...
function withWeather(OriginalComponent: React.ComponentType<ChildProps>, coordinates: GeolocationCoordinates | null) {
    ...
    const NewComponent = () => {
        ...
        return <OriginalComponent weather={weather} coordinates={defaultCoordinates} updateWeather={updateWeather} />;
    };
